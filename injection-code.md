...
<script src="https://cdn.jsdelivr.net/gh/thingv2-matty/coppers_hobbies@d221b5e/custom-code/search-engine.js"></script>
...
- search-engine.js last significant change: `d221b5e` (revert normalizeCat + localStorage; stable baseline)
