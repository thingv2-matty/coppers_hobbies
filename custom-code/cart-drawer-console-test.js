// Copper's Hobbies — Cart Drawer CONSOLE TEST
// ============================================
...
// 5. Test: click the cart icon, add a product, check qty buttons
// 6. Refreshing the page removes everything — nothing is saved
//
// If it all works, paste cart-drawer.html into Code Injection > Footer to make it permanent.
...
(function () {
  ...
  console.log('%c[CH] Cart drawer injected. Click the cart icon to test.', 'color:#c9943a;font-weight:bold');
