...
(function () {
  ...
  hpStyle.textContent = [
    ...
    '.ch-hp-comm-inner{max-width:1100px;margin:0 auto;padding:0 32px}',
    ...
    '.ch-hp-comm-cards{display:grid;grid-template-columns:repeat(6,1fr);gap:24px}',
    '.ch-hp-comm-cards .ch-hp-comm-card:nth-child(-n+3){grid-column:span 2}',
    '.ch-hp-comm-cards .ch-hp-comm-card:nth-child(4){grid-column:2/span 2}',
    '.ch-hp-comm-cards .ch-hp-comm-card:nth-child(5){grid-column:4/span 2}',
    '@media(max-width:760px){.ch-hp-comm-cards{grid-template-columns:1fr 1fr}.ch-hp-comm-cards .ch-hp-comm-card:nth-child(-n+5){grid-column:auto}}',
    '@media(max-width:480px){.ch-hp-comm-cards{grid-template-columns:1fr}}',
    ...
    '#ch-hs{position:fixed;inset:0;z-index:10000;background:rgba(31,28,24,.65);backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);display:none;align-items:flex-start;justify-content:center;padding-top:15vh}',
    '#ch-hs.on{display:flex}',
    '#ch-hs-inner{background:#fff;border-radius:12px;box-shadow:0 20px 60px rgba(31,28,24,.25);width:100%;max-width:620px;margin:0 20px;overflow:hidden}',
    '#ch-hs-top{display:flex;align-items:center;gap:10px;padding:14px 18px}',
    '#ch-hs-icon{color:#b8b0a6;flex-shrink:0;display:flex;align-items:center}',
    '#ch-hs-icon svg{width:18px;height:18px}',
    '#ch-hs-input{flex:1;border:none;outline:none;font-size:16px;font-family:"Work Sans",sans-serif;color:#1f1c18;background:none;min-width:0;padding:0}',
    ...
    '#ch-hs-drop{display:none;max-height:400px;overflow-y:auto;border-top:1px solid #ece4d6}',
  ...
  function initHeaderSearch() {
    ...
    iconEl.id = 'ch-hs-icon';
    iconEl.innerHTML = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>';
          ...
          '<div class="ch-hp-comm-cards">' +
            '<a href="/build-night" class="ch-hp-comm-card" style="text-decoration:none;color:inherit;display:block">' +
              ...
              '<div class="ch-hp-comm-card-body">' +
                ...
                '<p class="ch-hp-comm-card-p">Drop in any Sunday noon to 5 \u2014 bring your kit and join whoever shows up. All skill levels welcome.</p>' +
            ...
            '<a href="https://www.coppershobbies.com/scale-model-happenings" class="ch-hp-comm-card" style="text-decoration:none;color:inherit;display:block">' +
              ...
              '<div class="ch-hp-comm-card-body">' +
                '<span class="ch-hp-comm-badge ch-hp-comm-badge-cream">Events</span>' +
                '<h3 class="ch-hp-comm-card-h3">Scale Model Happenings</h3>' +
                '<p class="ch-hp-comm-card-p">Local shows, club meets, and scale model events in the area.</p>' +
