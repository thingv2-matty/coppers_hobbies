// CONSOLE TEST — paste into DevTools on /scale-model-happenings/waterloo-wellington-amps, refresh to remove
// Production file: custom-code/amps-page.js
(function () {
  'use strict';
  ...
  styleEl.textContent = [
    ...
    // Identity — dark military header, differentiates from the cream Copper's pages
